    ...
    return (
      <div className='home'>
          ...
          <div style={{ width: '100%' }}>
            <div className="row" style={{ width: '100%', marginLeft:"0" }}>
              <div className="col-12 mobile" style={{ marginTop: "90px" }}>
                <div className="item-category-moblie category-b">
                  <div className="item-category-moblie-content">
                    <p style={{ color: "#fff", textAlign: "center", fontWeight: "bold" }}>Toán</p>
                  </div>
                </div>
                <div className="item-category-moblie category-c">
                  <div className="item-category-moblie-content">
                    <p style={{ color: "#fff", textAlign: "center", fontWeight: "bold" }}>Vật lý</p>
                  </div>
                </div>
                <div className="item-category-moblie category-d">
                  <div className="item-category-moblie-content">
                    <p style={{ color: "#fff", textAlign: "center", fontWeight: "bold" }}>Hoá học</p>
                  </div>

                </div>
                <div className="item-category-moblie category-e">
                  <div className="item-category-moblie-content">
                    <p style={{ color: "#fff", textAlign: "center", fontWeight: "bold" }}>Lịch sử</p>
                  </div>
                </div>
                <div className="item-category-moblie category-f">
                  <div className="item-category-moblie-content">
                    <p style={{ color: "#fff", textAlign: "center", fontWeight: "bold" }}>Xã hội</p>
                  </div>
                </div>
                {/* <div className="item-category-moblie category-b"></div> */}
              </div>
              <div className='col-12 col-md-3 desktop' style={{ width: '100%' }}>
                <div className='info-category category-a'>
                  <div className="info-category-content">
                    <div className="info-category-content-circle">
                      <img src='/images/icon/math.png' style={{ width: "60%", height: "60%" }} />
                    </div>
                  </div>
                ...
                <div className='info-category category-b'>
                  <div className="info-category-content">
                    <div className="info-category-content-circle">
                      <img src='/images/icon/physical.png' style={{ width: "60%", height: "60%" }} />
                ...
                <div className='info-category category-c'>
                  <div className="info-category-content">
                    <div className="info-category-content-circle">
                      <img src='/images/icon/chemistry.png' style={{ width: "80%", height: "80%" }} />
                    </div>
                  </div>
                ...
                <div className='info-category category-d'>
                  <div className="info-category-content">
                    <div className="info-category-content-circle">
                      <img src='/images/icon/history.png' style={{ width: "70%", height: "70%" }} />
                    </div>
                  </div>
              ...
              <div className='col-12 col-md-9'>
                <div className='row' >
                  <div className="col-12 col-md-4" style={{ marginBottom: "35px" }} >
                    <div className="item-game">
                      <div className="item-game-image" >
                        <img src="./images/icon/ig.jpeg" className="item-game-image" style={{ width: '100%', height: "100%" }} />
                      </div>
                      <div className="item-game-content">
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "16px", color: "#383838" }}>Ai là triệu phú</p>
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "9px", color: "#383838" }}> 12/12/2020</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-md-4" style={{ marginBottom: '35px' }} >
                    <div className="item-game">
                      <div className="item-game-image" >
                        <img src="./images/icon/ig1.jpeg" className="item-game-image" style={{ width: '100%', height: "100%" }} />
                      </div>
                      <div className="item-game-content">
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "16px", color: "#383838" }}>Ai là triệu phú</p>
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "9px", color: "#383838" }}> 12/12/2020</p>
                  ...
                  <div className="col-12 col-md-4" style={{ marginBottom: '35px' }} >
                    <div className="item-game">
                      <div className="item-game-image" >
                        <img src="./images/icon/ig2.jpeg" className="item-game-image" style={{ width: '100%', height: "100%" }} />
                      </div>
                      <div className="item-game-content">
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "16px", color: "#383838" }}>Ai là triệu phú</p>
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "9px", color: "#383838" }}> 12/12/2020</p>
                  ...
                  <div className="col-12 col-md-4" style={{ marginBottom: '35px' }} >
                    <div className="item-game">
                      <div className="item-game-image" >
                        <img src="./images/icon/ig3.jpeg" className="item-game-image" style={{ width: '100%', height: "100%" }} />
                      </div>
                      <div className="item-game-content">
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "16px", color: "#383838" }}>Ai là triệu phú</p>
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "9px", color: "#383838" }}> 12/12/2020</p>
                  ...
                  <div className="col-12 col-md-4" style={{ marginBottom: '35px' }} >
                    <div className="item-game">
                      <div className="item-game-image" >
                        <img src="./images/icon/ig4.jpeg" className="item-game-image" style={{ width: '100%', height: "100%" }} />
                      </div>
                      <div className="item-game-content">
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "16px", color: "#383838" }}>Ai là triệu phú</p>
                        <p style={{ fontWeight: "bold", textAlign: "left", fontSize: "9px", color: "#383838" }}> 12/12/2020</p>
        ...
        <a onClick={() => this.top()} className='btnAdd'>
          <img src="/images/icon/btnAdd.png" style={{ height: "50%", width: "50%" }} />
        </a>
      </div>
    )
  }
