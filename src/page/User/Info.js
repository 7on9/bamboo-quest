    ...
    return (
      <div className='row'>
        <div className='col-12 col-sm-4 col-md-4'>
          ...
          <img src='/images/avatar.png' style={{ width: '100%', height: '15em', objectFit: 'cover' }} />
        </div>
          ...
          <div className='col-12 text-left' style={{ marginTop: '20px', justifyContent: 'center' }}>
            <div className='row'>
              ...
              <div className='col-md-10 col-12'>
                ...
                <Link to="/user/edit" className='col-12 btn btn-block btn-success' style={{ height: '40px' }} ><i className="fas fa-edit" />Chỉnh sửa </Link>
              </div>
              <div className='col-md-1 col-12'></div>
            </div>
          </div>
