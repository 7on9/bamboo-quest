...
class ReturnResult extends Component {
  ...
  render() {
    ...
    return (
      <div className='return-result center-div' style={{ justifyContent: 'center' }}>
        {
          this.props.game.correct == -1 ?
            <div style={{ color: '#ad1d1d' }}>
              <i className="fas fa-sad-tear" style={{ fontSize: '10vw', marginBottom: '20px' }}/>
              <h4 style={{ fontSize: '5vw' }}>Sai rồi</h4>
            </div> :
            this.props.game.correct == 1 ?
              <div style={{ color: '#138402' }}>
                <i className="fas fa-laugh" style={{ fontSize: '10vw', marginBottom: '20px' }}/>
